...
current_hour = now.hour # ດຶງຊົ່ວໂມງປັດຈຸບັນມາ (0-23)
...
# 💡 ຟັງຊັນສຳລັບລັອກໃຫ້ AI Predict ສະເພາະທຸກໆ 1 ຊົ່ວໂມງ (3600 ວິນາທີ)
@st.cache_data(ttl=3600)
def predict_hourly(df_dict, hour_stamp):
    # ປ່ຽນ dict ກັບມາເປັນ DataFrame
...
st.sidebar.write("*(ຂໍ້ມູນເຊັນເຊີອັບເດດທຸກໆ 5 ວິນາທີ)*")

# =========================================================
# 🤖 ສ່ວນໜ້າຈໍຫຼັກ: ປ້ອນຂໍ້ມູນໃຫ້ AI (ຈະ Predict ໃໝ່ທຸກໆຊົ່ວໂມງ)
# =========================================================
input_dict = {
...
# 💡 ເອີ້ນໃຊ້ຟັງຊັນລັອກເວລາ Predict (ຜົນຈະປ່ຽນກໍຕໍ່ເມື່ອຂຶ້ນຊົ່ວໂມງໃໝ່ current_hour ປ່ຽນ)
pred_pm25, pred_soil_hum = predict_hourly(input_dict, current_hour)
...
with col_pred1:
    st.subheader("🌤️ ຜົນວິເຄາະຄຸນນະພາບອາກາດ (AI - ລາຍຊົ່ວໂມງ)")
...
with col_pred2:
    st.subheader("🌱 ຜົນວິເຄາະຄຸນນະພາບດິນ (AI - ລາຍຊົ່ວໂມງ)")
...
fig_soil.update_layout(
    ...
    xaxis_title="<b>ເວລາ</b>", yaxis_title="%", height=350, margin=dict(l=20, r=20, t=50, b=20),
    font=dict(family="Phetsarath", size=13)
)
