...
st.markdown("<h2 style='text-align: left; color: #1E88E5; font-weight: bold; margin-bottom: 25px;'>📊 ຜົນການວິເຄາະຄຸນນະພາບອາກາດ ແລະ ດິນ (ເປັນຊົ່ວໂມງ) st.markdown(f"📆 **ວັນທີ:** {current_date} | 🕒 **ອັບເດດລ່າສຸດ:** {current_time}")</h2>", unsafe_allow_html=True)
